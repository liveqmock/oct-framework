Ext.define('Ext.ux.multiupload.Upload', {
    ...
    requires: [  'Ext.ux.multiupload.UploadManager' ],

    width: 101,
    height: 22,
    wmode: 'transparent',
    url: 'lib/ux/multiupload/Upload.swf',
    statics: {
        instanceId: 0
    },
    constructor: function (config) {
        ...
        config.flashVars = Ext.apply({
            ...
            buttonImagePath: 'lib/ux/multiupload/button.png',
            buttonImageHoverPath: 'lib/ux/multiupload/button_hover.png',
